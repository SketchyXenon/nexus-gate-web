            ...
            >
              <Card className="relative overflow-hidden border-border/60 shadow-xl backdrop-blur-sm bg-card/95">
                ...
                <CardContent>
                  ...
                  {/* EMAIL VERIFIED SUCCESS (after Supabase callback) */}
                  {mode === "verify-success" && (
                    <div className="space-y-5 text-center">
                      <motion.div
                        initial={{ scale: 0.6, opacity: 0 }}
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your email has been confirmed and your account is now
                        active. You can sign in with your email and password.
                      </p>
                      <div className="space-y-2">
                        <Button
                          type="button"
