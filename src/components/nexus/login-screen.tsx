...
export function LoginScreen({ initialMode = "landing" }: { initialMode?: Mode }) {
  ...
  // Handle Supabase password-recovery redirect (?code=...&type=recovery).
  // The email link sends the user here; we exchange the code for a session,
  // then show the new-password form. The session IS the auth for the reset.
  useEffect(() => {
                  ...
                  {mode === "login" && (
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleLogin} className="space-y-3">
                        ...
                        <TurnstileField ref={loginTurnstileRef} onToken={setLoginCfToken} />
                  ...
                  {mode === "register" && (
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleRegister} className="space-y-3">
                        ...
                        <TurnstileField ref={registerTurnstileRef} onToken={setRegisterCfToken} />
