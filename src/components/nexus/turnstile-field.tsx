...
>(function TurnstileField({ onToken, onError }, ref) {
  ...
  const [TurnstileComp, setTurnstileComp] = useState<
    typeof import("@marsidev/react-turnstile").Turnstile | null
  >(null);
  ...
  return (
    <div className="min-h-[20px]">
      {TurnstileComp ? (
        <TurnstileComp
          ref={(el: { reset: () => void } | null | undefined) => {
            widgetRef.current = el ?? null;
          }}
          siteKey={siteKey}
          onSuccess={onToken}
          onError={() => {
